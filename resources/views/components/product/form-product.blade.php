          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group my-1">
                ...
                <input type="number" name="harga_beli_pokok" id="harga_beli_pokok" class="form-control" value="{{ $id ? $harga_beli_pokok : old('harga_beli_pokokt') }}">
              </div>
              <div class="form-group my-1">
              ...
              <div class="form-group my-1 d-flex flex-column">
                ...
                <small class="text-secondary">Jika aktif, maka product akan ditampilkan di halaman kasir</small>
            </div>
            </div>
